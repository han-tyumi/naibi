...
**No stock, everyone passes at once** — Strip the pack down to exactly four cards per player — four ranks for four players and so on — and deal the whole thing out. There is no stock and no dealer advantage: every player simultaneously slides one unwanted card face down to their left and then picks up the one arriving from the right, over and over as fast as the group can go. When a player is knocked out, remove a spoon and one rank's worth of cards together so the arithmetic stays right. One account gives this as the base game and the stock version as the variation, and it is the older shape: the game was first recorded in this form.
